...
<!-- Account css js-->
 <link href="${pageContext.request.contextPath}/resources/assets3/css/bootstrap.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/jquery.mmenu.all.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/owl.carousel.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/cloudzoom.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/font-awesome.css" rel="stylesheet">
<%-- <link href="${pageContext.request.contextPath}/resources/assets3/css/home.css" rel="stylesheet"> --%>
<link href="${pageContext.request.contextPath}/resources/assets3/css/browse.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/product.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/checkout.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/request.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/login.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/cms.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/responsive.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/assets3/css/user-personal.css" rel="stylesheet">

<script src="${pageContext.request.contextPath}/resources/assets3/js/cart.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/jquery-1.9.1.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/bootstrap.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/jquery.mmenu.min.all.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/owl.carousel.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/cloudzoom.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/jquery.scrollToTop.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/style.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/common.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/fly.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/ajax.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/utility.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/popup.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/item.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/newletter.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/textutils.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/servicesource.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/urlcomponent.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/share.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets3/js/request.js"></script> 

	
	
<style type="text/css">#livechat-full {height: 440px !important;}</style>
<!-- End Account css js-->
...
<body>
	...
	<div class="page">
									...
									<ul id="cart-sidebar" class="mini-products-list">
										...
										<li class="item last odd"><a class="product-image"
											...
											<div class="detail-item">
												...
												<div class="product-details-bottom">
													<span class="price">$320.00</span> <span class="title-desc">Qty:</span>
													<strong>2</strong>
												</div>
											</div></li>
									</ul>
			...
			<div class="nav-inner">
										...
										<li class="level0 nav-6 level-top first parent"><a
											...
											<ul class="level0">
												...
												<li class="level1 nav-10-3"><a
													href="product-detail.html"> <span>Product Detail</span>
												</a></li>
				...
				<ul id="nav" class="hidden-xs">
					<li id="nav-home" class="level0 parent drop-menu"><a
						href="${pageContext.request.contextPath}/"><span>Home</span> </a>
							...
							<div class="level0-wrapper2">
								<div
									...
									<ul class="level0">
										...
										<li class="level1 nav-7-3 parent item"><a href="#"> <span>Men</span>
										</a>
											<ul class="level1">
										...
										<li class="level1 nav-7-4 parent item"><a href="#"> <span>Girls</span>
										</a>
											<ul class="level1">
									...
									<div class="fur-des">
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											elit. Nam fringilla augue nec est tristique auctor. Donec non
								...
								<div class="nav-block nav-block-right std grid12-4">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										Nam fringilla augue nec est tristique auctor.</p>
									...
									<ul class="level0">
										...
										<li class="level1 nav-6-1 parent item"><a
											...
											<ul class="level1">
												...
												<!--level2 nav-6-1-1-->
												<li class="level2 nav-6-1-1"><a
													href="#/jwellery/pendants.html"><span>Pendants</span></a></li>
												<!--level2 nav-6-1-1-->
												<li class="level2 nav-6-1-1"><a
										...
										<li class="level1 nav-6-1 parent item"><a
											...
											<ul class="level1">
												...
												<!--level2 nav-6-1-1-->
												<li class="level2 nav-6-1-1"><a
													href="#/swimwear/clothing.html"><span>Clothing</span></a></li>
												<!--level2 nav-6-1-1-->
												<li class="level2 nav-6-1-1"><a
		...
		<!-- main container -->
		<div class="container" style="background-image: url('${pageContext.request.contextPath}/resources/assets3/images/bg_eBay.jpg');">
			<div class="maincontent">
				<ol class="breadcrumb" style="background:white;">
					<li><a href="${pageContext.request.contextPath}/">TheTime</a></li>	&raquo;
					<li><a href="${pageContext.request.contextPath}/">My Account</a></li>	&raquo;
					<li class="active"><a href="${pageContext.request.contextPath}/">Informed</a></li>
				</ol>
				<div class="cate1 alluser clearfix">
					<div class="right-alluser">
						<span><jsp:include page="${page}" flush="true"></jsp:include></span>
					
					</div>
					<div class="leftcate1">
						<div class="box-ballet" style="background-image: url('${pageContext.request.contextPath}/resources/assets3/images/bg_boxballet.png');">
							<div class="nb-boxmoney">Zen: 0 đ</div>
							<div class="btn-buynow bnt-addmoney">
								<a href="${pageContext.request.contextPath}/">Nạp tiền vào ví</a>
							</div>
							<div class="btn-dtballet">
								<a href="${pageContext.request.contextPath}/">Chi tiết giao dịch »</a>
							</div>
						</div>
						<!-- box-ballet -->
						<div class="nav-user">
							<ul>
								<li class="top-user">Quản lý cá nhân</li>
								<li><a href="${pageContext.request.contextPath}/">Thông tin tài khoản <i
										class="nav-infoacount"></i></a></li>
								<li><a href="${pageContext.request.contextPath}/">Sổ địa chỉ</a></li>
								<li><a href="/wallet/listwallet">Zen Shopping</a></li>
								<li><a href="/user/coupon">Danh sách Coupon</a></li>
								<!--            <li><a href="#">Tin nhắn</a></li>-->
								<li><a href="/user/notification">Thông báo</a></li>
								<!--            <li><a href="#">Giới thiệu bạn bè</a></li>-->
								<li class="top-user active">Quản lý mua hàng</li>
								<li><a href="/user/order">Quản lý đơn hàng</a></li>
								<li><a href="/user/auction">Quản lý đấu giá</a></li>
								<li><a href="/user/quotes">Quản lý báo giá</a></li>
								<li><a href="/user/follow">Danh sách theo dõi</a></li>
								<li><a href="/user/claim">Trung tâm xử lý khiếu nại</a></li>
							</ul>
						</div>
					
						<!-- nav-notice -->
						<div class="box-ebay cms">
							<div class="topbox-ebay"></div>
							<div class="boxe">
								<div class="boxe-icon boxe1"></div>
								<div class="spe-boxe">
									<p>
										<span>Miễn phí vận chuyển</span>
									</p>
									<p>Giá trọn gói, bao gồm mọi khoản thuế, phí, giao tận tay
										người mua</p>
								</div>
							</div>
							<div class="boxe">
								<div class="boxe-icon boxe2"></div>
								<div class="spe-boxe">
									<p>
										<span>Miễn thủ tục hải quan</span>
									</p>
									<p>eBay.vn thay mặt người mua xử lý toàn bộ thủ tục, giấy
										tờ</p>
								</div>
							</div>
							<div class="boxe">
								<div class="boxe-icon boxe3"></div>
								<div class="spe-boxe">
									<p>
										<span>Thanh toán an toàn</span>
									</p>
									<p>Bảo hiểm 100% giá trị đơn hàng, theo chính sách của Ngân
										Lượng</p>
								</div>
							</div>
							<div class="boxe">
								<div class="boxe-icon boxe4"></div>
								<div class="spe-boxe">
									<p>
										<span>Giao hàng toàn quốc</span>
									</p>
									<p>Tới huyện xã trên 63 tỉnh thành Sau 10-20 ngày từ khi
										thanh toán</p>
								</div>
							</div>
							<div class="boxe">
								<div class="boxe-icon boxe5"></div>
								<div class="spe-boxe">
									<p>
										<span>Hỗ trợ rủi ro hàng hóa</span>
									</p>
									<p>Đối với hàng hỏng, mất, vỡ hoặc không đúng mô tả</p>
								</div>
							</div>
						</div>
						<!-- box-ebay -->
 ...
 <script>gapi.comments.render('google_comments',{href:window.location.href,width: 680,first_party_property: 'BLOGGER',view_type: 'FILTERED_POSTMOD'});
       function fix_google()
       {
		...
		<div class="footer-bottom">
			<div class="col-sm-5 col-xs-12 coppyright">&copy; 2015
				Magikcommerce. All Rights Reserved.</div>
