...
<meta property="fb:admins" content="Nguyễn Cảnh Thư" />
<meta property="fb:app_id" content="620439478110994" />
...
<body>
	...
	<div class="page">
						...
						<div class="mini-cart">
							<div data-toggle="dropdown" data-hover="dropdown"
								...
								<a href="#"> <i class="glyphicon glyphicon-shopping-cart"></i>
									<div class="cart-box">
										<span class="title">cart</span><span id="cart-total">${q }
											item </span>
									</div>
								</a>
							</div>
		...
		<div style="margin-top: 10px;" class="offer-banner-section">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="slider-items-products">
					<div id="brand-logo-slider"
						...
						<div class="slider-items slider-width-col6 owl-carousel owl-theme"
							style="opacity: 1; display: block;">

							<!-- Item -->
							<div class="owl-wrapper-outer">
								<div class="owl-wrapper"
									style="width: 2912px; left: 0px; display: block; transition: all 1000ms ease; transform: translate3d(0px, 0px, 0px);">
									<div class="owl-item" style="width: 182px;">
										<div class="item">
											<a href="#x"><img src="${pageContext.request.contextPath}/resources/assets2/images/b-logo1.png" alt="hình ảnh"></a>
										</div>
									</div>
									<div class="owl-item" style="width: 182px;">
										<div class="item">
											<a href="#x"><img src="${pageContext.request.contextPath}/resources/assets2/images/b-logo2.png" alt="hình ảnh"></a>
										</div>
									</div>
									<div class="owl-item" style="width: 182px;">
										<div class="item">
											<a href="#x"><img src="${pageContext.request.contextPath}/resources/assets2/images/b-logo3.png" alt="hình ảnh"></a>
										</div>
									</div>
									<div class="owl-item" style="width: 182px;">
										<div class="item">
											<a href="#x"><img src="${pageContext.request.contextPath}/resources/assets2/images/b-logo4.png" alt="hình ảnh"></a>
										</div>
									</div>
									<div class="owl-item" style="width: 182px;">
										<div class="item">
											<a href="#x"><img src="${pageContext.request.contextPath}/resources/assets2/images/b-logo5.png" alt="hình ảnh"></a>
										</div>
									</div>
									<div class="owl-item" style="width: 182px;">
										<div class="item">
											<a href="#x"><img src="${pageContext.request.contextPath}/resources/assets2/images/b-logo6.png" alt="hình ảnh"></a>
										</div>
									</div>
									<div class="owl-item" style="width: 182px;">
										<div class="item">
