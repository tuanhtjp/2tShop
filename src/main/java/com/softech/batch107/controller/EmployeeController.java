...
public class EmployeeController {
  ...
  //SHOW EDIT PAGE
  	...
  	//SHOW CREATE PAGE
  		...
  		public ModelAndView createEmployee(@RequestParam String fullName, @RequestParam String email, @RequestParam String password, @RequestParam String dob,@RequestParam String sex,@RequestParam String phone,@RequestParam String address, @RequestParam String image,@RequestParam String roleID, @RequestParam String status, HttpSession session, Model model) {
